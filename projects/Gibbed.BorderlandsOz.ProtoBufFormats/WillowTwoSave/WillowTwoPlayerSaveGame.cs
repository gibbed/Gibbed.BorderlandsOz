...
namespace Gibbed.BorderlandsOz.ProtoBufFormats.WillowTwoSave
{
    ...
    public class WillowTwoPlayerSaveGame : INotifyPropertyChanged
    {
        ...
        private List<BodySwitchesData> _BodySwitches = new List<BodySwitchesData>();
        ...
        private void OnDeserialization()
        {
            ...
            this._BodySwitches = this._BodySwitches ?? new List<BodySwitchesData>();
            this._PlayerFlags = this._PlayerFlags ?? new List<int>();
            this._DiscoveredInteractiveObjectCompassIcons =
                this._DiscoveredInteractiveObjectCompassIcons ?? new List<NameBasedObjectPath>();
        }
        ...
        private bool ShouldSerializeBodySwitches()
        {
            return this._BodySwitches != null &&
                   this._BodySwitches.Count > 0;
        }

        private bool ShouldSerializePlayerFlags()
        {
            return this._PlayerFlags != null &&
                   this._PlayerFlags.Count > 0;
        }

        private bool ShouldSerializeDiscoveredInteractiveObjectCompassIcons()
        {
            return this._DiscoveredInteractiveObjectCompassIcons != null &&
                   this._DiscoveredInteractiveObjectCompassIcons.Count > 0;
        }
        #endregion
        ...
        public List<BodySwitchesData> BodySwitches
        {
            get { return this._BodySwitches; }
            set
            {
                if (value != this._BodySwitches)
                {
                    this._BodySwitches = value;
                    this.NotifyOfPropertyChange(nameof(BodySwitches));
                }
            }
        }
        ...
        public List<int> PlayerFlags
        {
            ...
            set
            {
                if (value != this._PlayerFlags)
                {
                    this._PlayerFlags = value;
                    this.NotifyOfPropertyChange(nameof(PlayerFlags));
                }
            }
        }
        ...
        public List<NameBasedObjectPath> DiscoveredInteractiveObjectCompassIcons
        {
            get { return this._DiscoveredInteractiveObjectCompassIcons; }
            set
            {
                if (value != this._DiscoveredInteractiveObjectCompassIcons)
                {
                    this._DiscoveredInteractiveObjectCompassIcons = value;
                    this.NotifyOfPropertyChange(nameof(DiscoveredInteractiveObjectCompassIcons));
                }
            }
        }
        ...
        public bool? SuppressAtmosphereNotifications
        {
            ...
            set
            {
                if (value != this._SuppressAtmosphereNotifications)
                {
                    ...
                    this.NotifyOfPropertyChange(nameof(SuppressAtmosphereNotifications));
                }
            }
        }
