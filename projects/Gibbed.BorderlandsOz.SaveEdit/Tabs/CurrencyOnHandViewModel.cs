...
namespace Gibbed.BorderlandsOz.SaveEdit
{
    ...
    internal class CurrencyOnHandViewModel : PropertyChangedBase
    {
        ...
        public int ShiftCoins
        {
            get { return this._ShiftCoins; }
            set
            {
                if (this._ShiftCoins != value)
                {
                    this._ShiftCoins = value;
                    this.NotifyOfPropertyChange(nameof(ShiftCoins));
                }
            }
        }
        ...
        public void ImportData(WillowTwoPlayerSaveGame saveGame)
        {
            ...
            this.ReservedB = saveGame.CurrencyOnHand != null && saveGame.CurrencyOnHand.Count > 4
                                    ...
                                    : 0;
            this.ShiftCoins = saveGame.CurrencyOnHand != null && saveGame.CurrencyOnHand.Count > 5
        ...
        public void ExportData(WillowTwoPlayerSaveGame saveGame)
        {
            ...
            saveGame.CurrencyOnHand.Add(this.ShiftCoins);
